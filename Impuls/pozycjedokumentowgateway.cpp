...
PozycjeDokumentowGateway::PozycjeDokumentowGateway()
{
    ...
    selectPozycjeDok.setQuery(queryLiteralDokPoz);
}

QSqlQuery* PozycjeDokumentowGateway::select(int id_dok){
    selectPozycjeDok.prepare();
    selectPozycjeDok.bindValue(":id_dok",id_dok);
    selectPozycjeDok.bindValue(":ID_FIRMY",1);
    selectPozycjeDok.execute();
    return selectPozycjeDok.getQuery();
}
